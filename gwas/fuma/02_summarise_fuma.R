...
# the job directory downloaded from the FUMA web service
FUMA_DIR <- Sys.getenv("FUMA_DIR", file.path(PROJECT_DIR, "input", "fuma"))
fuma_1e5   <- file.path(FUMA_DIR, "FUMA_1e5")
output_dir <- file.path(PROJECT_DIR, "output", "gwas_fuma", "summary")
