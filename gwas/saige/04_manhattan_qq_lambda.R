...
#> ship output/gwas_plots/primary/top10_snps.csv -> input/assoc_results/gwas_primary_lead_snps.csv
...
SUMSTATS <- Sys.getenv("SUMSTATS", unset = file.path(
  PROJECT_DIR, "input", "assoc_results", "gwas_primary_sumstats.tsv.gz"))
