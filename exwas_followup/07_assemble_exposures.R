#!/usr/bin/env Rscript
#> ship output/followup_exwas/derive/exwas_followup_{group}.csv -> input/analysis_ready/
#> ship output/followup_exwas/derive/followup_exwas_variable_dictionary.csv -> input/analysis_ready/
