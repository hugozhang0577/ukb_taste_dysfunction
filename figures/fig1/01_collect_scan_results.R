...
#> in   input/assoc_results/mwas_{}_primary.csv
#> in   input/assoc_results/pwas_primary.csv
#> in   input/reference/nmr_metabolite_annotation.csv
#> opt  input/assoc_results/pwas_{group}_primary.csv
#> out  output/evidence_tiering/tier_flagged_results.csv
...
load_gwas_g1 <- function() {
  log_msg("GWAS sumstats deferred — only lead SNPs are used, by the Manhattan panel")
  data.table(
