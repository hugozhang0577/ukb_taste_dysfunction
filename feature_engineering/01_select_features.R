#!/usr/bin/env Rscript
#> in   input/analysis_ready/baseline_exwas_variable_dictionary.csv
#> in   input/assoc_results/dwas_phecode_primary.csv
#> in   input/assoc_results/exwas_baseline_female_primary.csv
#> in   input/assoc_results/exwas_baseline_primary.csv
#> in   input/assoc_results/exwas_followup_primary.csv
#> in   input/assoc_results/mwas_cluster_representatives.csv
#> in   input/assoc_results/pwas_primary.csv
#> in   input/reference/nmr_metabolite_annotation.csv
#> out  output/feature_manifest/master_feature_manifest.csv
suppressPackageStartupMessages(library(data.table))

PROJECT_DIR <- Sys.getenv("PROJECT_DIR", unset = ".")
if (!dir.exists(PROJECT_DIR))
  stop("PROJECT_DIR does not exist: ", PROJECT_DIR,
       "\n  it must be writable; on RAP use a work directory and link the
       inputs in: ln -s /mnt/project/input <workdir>/input")
setwd(PROJECT_DIR)
...
MWAS_ANNOT     <- "input/reference/nmr_metabolite_annotation.csv"
...
EXWAS_A_DICT   <- file.path(IN_READY,   "baseline_exwas_variable_dictionary.csv")
