#!/usr/bin/env Rscript
#> in   output/feature_manifest/master_feature_manifest.csv
#> out  output/feature_manifest/master_feature_manifest_final.csv
#> out  output/feature_manifest/tier_model_definitions_final.csv
#> out  output/ml_ready/{}_{}.rds
