#!/usr/bin/env Rscript
#> in   input/metabolomics/nmr_merged_all.csv
#> in   output/metabolomics_qc
#> out  output/metabolomics_qc/nmr_biomarker_qc_flags.csv
#> out  output/metabolomics_qc/nmr_biomarkers_qc.csv
#> out  output/metabolomics_qc/nmr_extended_ratios.csv
rm(list = ls())
gc()
