#> in   output/metabolomics_qc/nmr_biomarker_qc_flags.csv
#> in   output/metabolomics_qc/nmr_biomarkers_qc.csv
#> in   output/metabolomics_qc/nmr_extended_ratios.csv
#> in   output/mwas/derive
#> ship output/mwas/derive/metabolomics_{group}.csv -> input/analysis_ready/
rm(list = ls())
gc()
