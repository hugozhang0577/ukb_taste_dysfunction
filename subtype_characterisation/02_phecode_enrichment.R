#!/usr/bin/env Rscript
#> in   input/analysis_ready/phecode_matrix_group1.rds
#> in   input/assoc_results/dwas_phecode_primary.csv
#> in   output/ml_ready/group1_full.rds
#> in   output/subtyping/inputs/view_partition.csv
#> out  output/subtyping/evidence_disease/phecode_enrichment_g1_by_subtype.csv
