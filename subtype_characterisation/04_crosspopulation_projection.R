...
#> in   output/subtyping/clusters/cluster_assignments_g1{}_k4.rds
#> in   output/subtyping/inputs/clustering_input_{}{}.rds
#> in   output/subtyping/mofa/mofa_loadings_g1{}.rds
rm(list = ls()); gc()
