...
#> in   output/subtyping/mofa/mofa_model_g1{}_reseed{}.hdf5
#> out  output/subtyping/clusters/cluster_assignments_g1{}_k{}.rds
rm(list = ls()); gc()
...
mofa <- run_mofa(mofa, outfile = hdf5, use_basilisk = USE_BASILISK)
