#!/usr/bin/env Rscript
#> in   input/analysis_ready/tastetime_assesstime.csv
#> in   output/dwas/derive/fo_long.rds
#> out  output/dwas/derive/phecode_matrix_{}.rds
#> ship output/dwas/derive/phecode_matrix_{group}.rds -> input/analysis_ready/
