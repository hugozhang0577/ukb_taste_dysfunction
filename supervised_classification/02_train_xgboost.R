...
#> out  output/model_reports/xgb_best_params.csv
#> out  output/models/xgboost/{}_booster.rds
#> out  output/models/xgboost/{}_importance.csv
#> out  output/models/xgboost/{}_oof_preds.rds
rm(list = ls()); gc()
