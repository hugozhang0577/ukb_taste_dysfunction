...
#> in   output/models/xgboost/predictions/{}_{}_preds.rds
#> in   output/models/xgboost/{}_oof_calibrated.rds
#> out  output/model_reports/eval/fairness_gaps_summary.csv
#> out  output/model_reports/eval/fairness_subgroup_metrics.csv
