#!/usr/bin/env Rscript
#> in   output/ml_ready/group{}_full.rds
#> in   output/model_reports/eval/fairness_gaps_summary.csv
#> in   output/model_reports/eval/fairness_subgroup_metrics.csv
#> in   output/model_reports/eval/heldout_val_delong_vs_g1.csv
#> in   output/model_reports/eval/heldout_val_summary.csv
#> in   output/model_reports/eval/sensitivity_no_smell_delong_vs_original.csv
#> in   output/model_reports/eval/sensitivity_no_smell_feature_counts.csv
#> in   output/model_reports/eval/sensitivity_no_smell_summary.csv
#> in   output/model_reports/eval/xgb_delong_pairwise.csv
#> in   output/model_reports/eval/xgb_eval_summary.csv
#> in   output/model_reports/fig_tables
#> in   output/model_reports/xgb_best_params.csv
#> in   output/models/xgboost/M1_TierA_importance.csv
#> in   output/models/xgboost/{}_importance.csv
rm(list = ls()); gc()
