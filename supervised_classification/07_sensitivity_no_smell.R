#!/usr/bin/env Rscript
#> in   output/feature_manifest/model_feature_recipes.csv
#> in   output/ml_ready/group1_{}.rds
#> in   output/ml_ready/group{}_{}.rds
#> in   output/model_reports/xgb_best_params.csv
#> out  output/model_reports/eval/sensitivity_no_smell_delong_vs_original.csv
#> out  output/model_reports/eval/sensitivity_no_smell_feature_counts.csv
#> out  output/model_reports/eval/sensitivity_no_smell_summary.csv
#> out  output/models/xgboost/sensitivity_no_smell/{}_booster.rds
#> out  output/models/xgboost/sensitivity_no_smell/{}_importance.csv
#> out  output/models/xgboost/sensitivity_no_smell/{}_oof_calibrated.rds
#> out  output/models/xgboost/sensitivity_no_smell/{}_oof_preds.rds
