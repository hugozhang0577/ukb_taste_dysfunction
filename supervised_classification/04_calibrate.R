...
#> in   output/models/xgboost/{}_oof_preds.rds
#> out  output/models/xgboost/calibrators/{}_isotonic.rds
#> out  output/models/xgboost/calibrators/{}_platt.rds
#> out  output/models/xgboost/{}_oof_calibrated.rds
...
# The calibrators fitted here are not reported, but they are applied: the
# held-out step reuses them unchanged and the fairness audit reads calibrated
# predictions, so removing this step changes those numbers.
# ---- helpers ----------------------------------------------------------------
