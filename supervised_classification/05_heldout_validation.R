...
#> in   output/models/xgboost/calibrators/{}_isotonic.rds
#> in   output/models/xgboost/calibrators/{}_platt.rds
#> in   output/models/xgboost/{}_booster.rds
#> in   output/models/xgboost/{}_oof_calibrated.rds
#> out  output/model_reports/eval/heldout_val_delong_vs_g1.csv
#> out  output/model_reports/eval/heldout_val_summary.csv
#> out  output/models/xgboost/predictions/{}_{}_preds.rds
