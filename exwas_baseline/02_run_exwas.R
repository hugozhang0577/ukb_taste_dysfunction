#!/usr/bin/env Rscript
#> ship output/baseline_exwas/baseline_exwas_results_group1_primary.csv -> input/assoc_results/exwas_baseline_primary.csv
#> ship output/baseline_exwas/baseline_exwas_results_group1_female.csv -> input/assoc_results/exwas_baseline_female_primary.csv
