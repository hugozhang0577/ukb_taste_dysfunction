#!/usr/bin/env Rscript
#> in   input/raw/baseline_exwas_table_export.csv
#> ship output/baseline_exwas/derive/exwas_baseline_{group}.csv -> input/analysis_ready/
#> ship output/baseline_exwas/derive/baseline_exwas_variable_dictionary.csv -> input/analysis_ready/
