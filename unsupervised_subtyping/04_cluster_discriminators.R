...
#> in   output/subtyping/clusters/cluster_assignments_g1{}.rds
#> out  output/subtyping/reports/cluster_profiles{}.csv
#> out  output/subtyping/reports/fig_tables/table_cluster_topfeatures{}.csv
