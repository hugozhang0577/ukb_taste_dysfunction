...
#> in   output/subtyping/reports/cluster_profiles_{}_k4.csv
#> in   output/subtyping/reports/fig_tables/table_cluster_topfeatures_{}_k4.csv
...
FEAT_SPEC <- rbind(
  ...
  data.table(domain = "Psychiatric",         feature_id = "neuroticism",         display = "Neuroticism score",   unit = "0-12",     type = "cont"),
  data.table(domain = "Psychiatric",         feature_id = "phq12_somatic_total", display = "Somatic symptoms (4-item)", unit = "0-8",     type = "cont"),
