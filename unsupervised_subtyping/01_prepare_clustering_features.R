...
#> in   output/ml_ready/{}_full.rds
#> out  output/subtyping/inputs/clustering_input_g1{}.rds
#> out  output/subtyping/inputs/clustering_input_{}{}.rds
#> out  output/subtyping/inputs/view_partition.csv
rm(list = ls()); gc()
