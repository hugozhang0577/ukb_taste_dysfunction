...
#> out  output/subtyping/mofa/mofa_factors_g1{}.rds
#> out  output/subtyping/mofa/mofa_loadings_g1{}.rds
#> out  output/subtyping/mofa/mofa_model_g1{sex}.hdf5
#> out  output/subtyping/reports/factor_activity{}.csv
